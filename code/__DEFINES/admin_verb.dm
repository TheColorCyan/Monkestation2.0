 ...
 */
#define _ADMIN_VERB(verb_path_name, verb_permissions, exact_permissions, verb_name, verb_desc, verb_category, show_in_context_menu) \
...
#define _ADMIN_VERB_CONTEXT(verb_path_name, verb_permissions, exact_permissions, verb_name, verb_desc, verb_category, context_type) \
/datum/admin_verb/##verb_path_name \
{ \
	name = ##verb_name; \
	description = ##verb_desc; \
...
#define ADMIN_VERB(verb_path_name, verb_permissions, exact_permissions, verb_name, verb_desc, verb_category) \
_ADMIN_VERB(verb_path_name, verb_permissions, exact_permissions, verb_name, verb_desc, verb_category, FALSE)

#define ADMIN_VERB_ONLY_CONTEXT_MENU(verb_path_name, verb_permissions, exact_permissions, verb_name, context_type) \
_ADMIN_VERB_CONTEXT(verb_path_name, verb_permissions, exact_permissions, verb_name, ADMIN_VERB_NO_DESCRIPTION, ADMIN_CATEGORY_HIDDEN, context_type)

#define ADMIN_VERB_AND_CONTEXT_MENU(verb_path_name, verb_permissions, exact_permissions, verb_name, verb_desc, verb_category, context_type) \
_ADMIN_VERB_CONTEXT(verb_path_name, verb_permissions, exact_permissions, verb_name, verb_desc, verb_category, context_type)
